...
> 自动更新时间：2026-02-27 | 全部按工作日（周一~周五）运行 | 时区：Asia/Shanghai

## 一、竞赛选手任务（盘中）

| 时间 | 任务名 | 选手 | 内容 | 超时 |
|------|--------|------|------|------|
| 08:30 | `value-news-scan` | 巴菲特门徒 🏛️ | 新闻扫描，分析持仓公司及 A 股重大新闻，生成交易建议 | 900s |
...
| 时间 | 任务名 | 内容 | 超时 |
|------|--------|------|------|
| 15:10 | `dwj-close-update` | 趋势游侠收盘 K 线缓存更新 + 净值确认 | 180s |
